...
class DataBasePlayer(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        val createNivelesTable = """
            CREATE TABLE IF NOT EXISTS $TABLE_NIVELES (
                ...
                $COLUMN_DIFFICULTY TEXT DEFAULT ''
            )
        """
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        ...
        if (oldVersion < 12) {
            ...
            ADD COLUMN $COLUMN_DIFFICULTY TEXT DEFAULT ''
        """)
        }
    }

    fun insertNivel(canal: String,
                    cancion: String,
                    nivel: String,
                    puntaje: String,
                    grade: String,
        ...
        val cursor = db.rawQuery(
            ...
            """,
            arrayOf(canal, cancion, nivel, grade, type, player, chartName, credit, difficulty)
        )
    ...
    fun updatePuntaje( canal: String,
                       cancion: String,
                       nivel: String,
                       type: String,
                       player: String,
    ...
    fun getSongScores(db: SQLiteDatabase, canal: String, cancion: String): Array<ObjPuntaje> {
        ...
        val cursor = db.rawQuery(
            """
                SELECT cancion, puntaje, grade, type, player, chartname, credit, difficulty
                FROM niveles 
